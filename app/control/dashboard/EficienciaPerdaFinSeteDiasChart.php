...
class EficienciaPerdaFinSeteDiasChart extends Page
{
    public function __construct() 
    {
        ...
        try {
            ...
            $valores = Negociacao::getEficienciaPerdaSeteDias();
            Transaction::close();
        } catch (\Exception $e) {
        ...
        $template = $twig->render('eficiencia_perda_fin_sete_dias.html', $replaces);
